...
# Стоимость и сроки
Окончательная стоимость и сроки зависят от объема и сложности проекта. Я готов обсудить проект и предложить точную оценку. В среднем, верстка одной страницы занимает от 1-го дня и стоит от 10 000р. Цена 1го блока от 1500р.
